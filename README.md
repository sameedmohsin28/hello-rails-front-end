...
**Hello Rails Front End** is an api which gives displays a random greeting upon every refresh.
...
`git clone https://github.com/sameedmohsin28/hello-rails-front-end.git`
...
Feel free to check the [issues page](https://github.com/sameedmohsin28/hello-rails-front-end/issues).
...
I would like to thank Microverse for teaching me this project.
...
This project is [MIT](https://github.com/sameedmohsin28/hello-rails-front-end/blob/hello-rails-backend/LICENSE) licensed.
